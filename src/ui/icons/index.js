(() => {
    const ICONS = {
        ...
        'edit': '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none"> <path d="M4 11.8 11.8 4l.9.9L4.9 12.7H4v-.9z" stroke="currentColor" stroke-width="1.4" stroke-linejoin="round"/> <path d="M9.8 4.9l1.3 1.3" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/> </svg>',
        ...
        'filter': '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none"> <path d="M3 4h10L9 8v4l-2 1V8L3 4z" stroke="currentColor" stroke-width="1.4" stroke-linejoin="round"/> </svg>',
        'git': '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none"> <circle cx="5" cy="4" r="1.5" stroke="currentColor" stroke-width="1.4"/> <circle cx="5" cy="12" r="1.5" stroke="currentColor" stroke-width="1.4"/> <circle cx="11" cy="8" r="1.5" stroke="currentColor" stroke-width="1.4"/> <path d="M5 5.5v5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/> <path d="M5 8h4.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/> </svg>',
        'branch': '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none"> <circle cx="5" cy="4" r="1.4" stroke="currentColor" stroke-width="1.4"/> <circle cx="5" cy="12" r="1.4" stroke="currentColor" stroke-width="1.4"/> <circle cx="11" cy="8" r="1.4" stroke="currentColor" stroke-width="1.4"/> <path d="M5 5.6v4.8" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/> <path d="M5 8h4.4" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/> </svg>',
        'remote': '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none"> <path d="M5.2 10.6H5a3 3 0 1 1 .6-5.9A3.6 3.6 0 0 1 12.8 6.2a2.4 2.4 0 0 1-.3 4.8H5.2z" stroke="currentColor" stroke-width="1.4" stroke-linejoin="round"/> </svg>',
